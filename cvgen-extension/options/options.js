...
function bindEvents() {
  ...
  // ── Enregistrer URL API ─────────────────────────────────
  document.getElementById('btn-save-api').addEventListener('click', async function () {
  ...
  document.getElementById('btn-reset-api').addEventListener('click', async function () {
  ...
  document.getElementById('btn-clear-cache').addEventListener('click', async function () {
    if (!confirm('Vider le cache supprimera votre token et votre profil local. Continuer ?')) return;
